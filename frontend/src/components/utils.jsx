import { getBackendRoot } from '../api/axios'
...
/** Converts relative photo path to absolute if needed */
...
export function Avatar({ src, name, size = 'md' }) {
  ...
  if (resolvedSrc) {
    return <img src={resolvedSrc} alt={name} className={`${cls} rounded-full object-cover border-2 border-white shadow`} />
  }
  return (
